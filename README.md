...
Este projeto está em desenvolvimento. Nem todas as funcionalidades estão implementadas.
...
* `"MariaDB"`: Conecta-se a um banco MariaDB usando **Entity Framework Core**.
